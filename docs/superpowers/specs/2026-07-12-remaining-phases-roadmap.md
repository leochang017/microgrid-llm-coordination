...
- **Efficiency-vs-equity tradeoff figure (advisor 2026-07-15):** served-load vs fairness (Gini/Jain) scatter, per method per cell — the advisor expects this tradeoff discussion to be "more interesting than the absolute performance numbers"; give it a dedicated figure + paragraph, not a footnote.
...
- Venue per advisor 2026-07-15 (supersedes the 2026-05-26 list): **CHI, ICLR, or WWW — main conference or a workshop under it** (workshop deadlines run ~3–4 months after the main deadline); track deadlines via the mlciv.com AI-conference-deadlines site. Decision at 3.3 exit with the advisor once Phase 3 results show the paper's strength; deadlines drive the writing calendar.
