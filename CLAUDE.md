...
- **Current position:** Task 16 next (engine main loop + strict energy-balance assertions). Tasks 0-15 complete — deterministic household sampling lands. Note: CI was red from Tasks 11-14 due to a `pyproject.toml` packaging issue; fixed in commit `d23fc7f` (Task 15-prep) and now green. Lesson saved as a workflow preference.
